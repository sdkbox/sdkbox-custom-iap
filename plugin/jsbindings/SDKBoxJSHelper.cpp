...
#if defined(MOZJS_MAJOR_VERSION)
bool js_SDKBox_init(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    ...
    if (argc == 2) {
        ...
        JSB_PRECONDITION2(ok, cx, false, "js_SDKBox_init : Error processing arguments");
        sdkbox::init(arg0, arg1);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportErrorUTF8(cx, "js_SDKBox_init : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
JSBool js_SDKBox_init(JSContext *cx, uint32_t argc, jsval *vp)
{
...
#if defined(MOZJS_MAJOR_VERSION)
bool js_SDKBox_setConfig(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
        ...
        JSB_PRECONDITION2(ok, cx, false, "js_SDKBox_setConfig : Error processing arguments");
        sdkbox::setConfig(arg0);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportErrorUTF8(cx, "js_SDKBox_setConfig : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
JSBool js_SDKBox_setConfig(JSContext *cx, uint32_t argc, jsval *vp)
{
    jsval *argv = JS_ARGV(cx, vp);
    JSBool ok = JS_TRUE;
    if (argc == 1) {
...
#if defined(MOZJS_MAJOR_VERSION)
bool js_SDKBox_getConfig(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 0) {
    ...
    JS_ReportErrorUTF8(cx, "js_SDKBox_getConfig : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
JSBool js_SDKBox_getConfig(JSContext *cx, uint32_t argc, jsval *vp)
{
    jsval *argv = JS_ARGV(cx, vp);
    JSBool ok = JS_TRUE;
    if (argc == 0) {
...
#if defined(MOZJS_MAJOR_VERSION)
#if MOZJS_MAJOR_VERSION >= 33
void register_all_SDKBoxJS_helper(JSContext* cx, JS::HandleObject global) {
    JS::RootedObject pluginObj(cx);
    sdkbox::getJsObjOrCreat(cx, global, "sdkbox", &pluginObj);

    JS_DefineFunction(cx, pluginObj, "init", js_SDKBox_init, 2, JSPROP_READONLY | JSPROP_PERMANENT);
    JS_DefineFunction(cx, pluginObj, "setConfig", js_SDKBox_setConfig, 1, JSPROP_READONLY | JSPROP_PERMANENT);
    JS_DefineFunction(cx, pluginObj, "getConfig", js_SDKBox_getConfig, 0, JSPROP_READONLY | JSPROP_PERMANENT);
}
#else
void register_all_SDKBoxJS_helper(JSContext* cx, JSObject* global) {
    JS::RootedObject pluginObj(cx);
    sdkbox::getJsObjOrCreat(cx, JS::RootedObject(cx, global), "sdkbox", &pluginObj);
...
void register_all_SDKBoxJS_helper(JSContext* cx, JSObject* global) {
    jsval pluginVal;
    JSObject* pluginObj;
    pluginVal = sdkbox::getJsObjOrCreat(cx, global, "sdkbox", &pluginObj);
